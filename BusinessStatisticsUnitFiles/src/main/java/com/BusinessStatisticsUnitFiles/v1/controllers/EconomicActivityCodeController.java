...
import com.BusinessStatisticsUnitFiles.dataAccessObject.IEconomicActivityCodeRepository;
...
public class EconomicActivityCodeController implements IGenericCRUD<EconomicActivityCodeModel> {
    ...
    public ResponseEntity<Void> create(@Valid @RequestBody EconomicActivityCodeModel newActivity){
        ...
        responseHeaders.setLocation(ServletUriComponentsBuilder.fromCurrentRequest().path("/{id}").buildAndExpand(newActivity.getEconomicActivityCodeId()).toUri());
